      ...
      <div className=" mt-16 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 bg-white rounded-2xl shadow-sm p-6">
            <div className="mb-6">
              <div className="grid grid-cols-12 gap-4 text-sm font-medium text-gray-500 uppercase tracking-wider pb-4 border-b">
            ...
            <div className="space-y-6">
              {cartItems.map((item) => (
                <div
                  ...
                  className="grid grid-cols-12 gap-4 items-center pb-6 border-b"
                >
                  {/* Product Info */}
            ...
            <Link
              href="/products"
              className="inline-block mt-6 text-sm font-medium text-gray-600 hover:text-gray-900 underline"
            >
              Continue Shopping
            </Link>
          </div>
          ...
          <div className="fixed inset-0 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8">
              ...
              <p className="text-gray-600 mb-6">
                Please sign in with your Google account to continue to checkout.
              </p>
             <Link href="auth/Signin">
             
              <button
               
                className="w-full py-3 bg-white border-2 border-gray-300 text-gray-700 font-semibold rounded-lg hover:bg-gray-50 transition-colors flex items-center justify-center gap-3 mb-4"
              >
